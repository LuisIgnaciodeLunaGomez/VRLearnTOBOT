...
\begin{itemize}
	...
	\item \textbf{Visualización de conexiones e identificación de \texttt{nextStatementContainer}:} Las conexiones lógicas (\texttt{Connection}) tienen su reflejo visual en las \texttt{ConnectionView}s. 
\end{itemize}
