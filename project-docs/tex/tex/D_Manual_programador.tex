...
\begin{itemize}
	\item \texttt{Core/}: Lógica central del modelo de datos de UBlockly (Block.cs, Connection.cs, Workspace.cs,Field.cs, etc.) y el motor de ejecución (CSharpRunner.cs, Cmdtor.cs). Se incluye en este directorio el de controllers para la integración del MVC.
...
\begin{enumerate}
	\item Una vez abierto el proyecto en Unity, localizar la escena principal (ej. en \texttt{Assets/Scenes/MainMenu.unity}).
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Escenario 3:  Probar la lógica de bumping al insertar bloques en una pila existente.
		\item Escenario 4:  Probar el descarte de bloques para verificar que los mismos eran eliminados del espacio de trabajo.
	\end{itemize}
