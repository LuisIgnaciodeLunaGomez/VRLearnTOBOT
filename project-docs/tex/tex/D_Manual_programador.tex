...
\begin{itemize}
	\item \texttt{Scenes/Desafios/}: Scripts centrales que gestionan el flujo de la aplicación: \texttt{GameManager.cs}, \texttt{IDE\_UIManager.cs}, \texttt{RobotController.cs}, \texttt{CommandParser.cs}, \texttt{Instruction.cs}, y el sistema de gestión de desafíos con \texttt{ChallengeData.cs} y \texttt{ChallengeLoader.cs}.
