...
\begin{itemize}
	...
	\item \textbf{Hito 5: Reto técnico y pivote estratégico.} Tras la implementación de las bases, se identificó que la creación de un motor de layout dinámico para los bloques de control de flujo complejos (ej. bucles anidados) era un desafío técnico mayor de lo previsto. En línea con la metodología ágil, se tomó la decisión estratégica de pivotar hacia un sistema que permitirá reutilizar la implementación de Ublockly para la representación de bloques y la creación de un sistema para la codificación mediante texto. El objetivo era mantener una estructura visual pero introducir un DSL textual para los comandos, asegurando así la viabilidad del proyecto.

	\item \textbf{Hito 6: Desarrollo del sistema de programación con DSL (MVP).} Implementación del CommandParser, el ProgramBuilder y el IDE\_UIManager. Adaptación del GameManager y RobotController para ejecutar la List<Instruction> generada por el parser. Diseño de la estructura de ChallengeData para los desafíos.
...
\begin{itemize}
	...
	\begin{itemize}
		\item Se redactó la versión final de todos los capítulos de la memoria, asegurando que la narrativa del pivote estratégico y el sistema fuera coherente a lo largo de todo el documento con respecto a la versión que se realizo en otro sprint anterior.
