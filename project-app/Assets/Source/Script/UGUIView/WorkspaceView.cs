...
namespace UBlockly.UGUI
{
    public class WorkspaceView : MonoBehaviour
    {
        ...
        public BlockView CloneBlockView(BlockView blockView, Vector2 xyPos)
        {
            ...
            BlockModel newBlock = blockView.Block.Clone();
            newBlock.XY = xyPos;
        ...
        {
            List<BlockModel> topBlocks = mWorkspace.GetTopBlocks(false);
        ...
        private BlockView BuildBlockView(BlockModel block)
        {
            ...
            foreach (BlockModel childBlock in block.ChildBlocks)
            {
