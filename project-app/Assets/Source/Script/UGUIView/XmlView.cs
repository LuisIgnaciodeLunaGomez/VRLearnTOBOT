    ...
    public class XmlView : MonoBehaviour
    {
        ...
        private void Awake()
        {
          ...
          //  m_SaveOkBtn.onClick.AddListener(SaveXml);
            m_SaveOkBtn.onClick.AddListener(SaveWorkspace);
        }

        protected void SaveWorkspace()
        {
            // Solo notifica al controlador
            BlocklyUI.WorkspaceController.SaveWorkspace(m_SaveNameInput.text);
            HideSavePanel();
        }
        internal virtual void ShowSavePanel()
        {
            m_SavePanel.SetActive(true);
            m_LoadPanel.SetActive(false);
        }

        protected void LoadWorkspace(string fileName)
        {
            // Solo notifica al controlador
            StartCoroutine(BlocklyUI.WorkspaceController.LoadWorkspace(fileName));
            HideLoadPanel();
        }
        ...
        internal virtual void ShowLoadPanel()
        {
