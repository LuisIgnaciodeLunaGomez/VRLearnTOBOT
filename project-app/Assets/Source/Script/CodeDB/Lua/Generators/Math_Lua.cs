...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private CodeStruct Math_Number(BlockModel block)
        {
        ...
        private CodeStruct Math_Arithmetic(BlockModel block)
        {
        ...
        private CodeStruct Math_Single(BlockModel block)
        {
        ...
        private CodeStruct Math_Trigonometry(BlockModel block)
        {
            return Math_Single(block);
        }

        [CodeGenerator(BlockType = "math_constant")]
        private CodeStruct Math_Constant(BlockModel block)
        {
        ...
        private CodeStruct Math_NumberProperty(BlockModel block)
        {
        ...
        private CodeStruct Math_Round(BlockModel block)
        {
            return Math_Single(block);
        }
        
        [CodeGenerator(BlockType = "math_on_list")]
        private CodeStruct Math_OnList(BlockModel block)
        {
        ...
        private CodeStruct Math_Modulo(BlockModel block)
        {
        ...
        private CodeStruct Math_Constrain(BlockModel block)
        {
        ...
        private CodeStruct Math_RandomInt(BlockModel block)
        {
        ...
        private CodeStruct Math_RandomFloat(BlockModel block)
        {
