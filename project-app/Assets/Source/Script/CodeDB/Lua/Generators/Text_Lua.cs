...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private CodeStruct Text(BlockModel block)
        {
        ...
        private CodeStruct Text_Join(BlockModel block)
        {
        ...
        private string Text_Append(BlockModel block)
        {
        ...
        private CodeStruct Text_Length(BlockModel block)
        {
        ...
        private CodeStruct Text_IsEmpty(BlockModel block)
        {
            string text = Lua.Generator.ValueToCode(block, "VALUE", Lua.ORDER_UNARY);
            if (string.IsNullOrEmpty(text)) text = "\'\'";
        ...
        private CodeStruct Text_IndexOf(BlockModel block)
        {
        ...
        private CodeStruct Text_CharAt(BlockModel block)
        {
            // Get letter at index.
...
"function " + Generator.FUNCTION_NAME_PLACEHOLDER + @"(str, index)
    return string.sub(str, index, index)
        ...
        private CodeStruct Text_GetSubstring(BlockModel block)
        {
        ...
        private CodeStruct Text_ChangeCase(BlockModel block)
        {
        ...
        private CodeStruct Text_Trim(BlockModel block)
        {
        ...
        private string Text_Print(BlockModel block)
        {
            string text = Lua.Generator.ValueToCode(block, "TEXT", Lua.ORDER_NONE, "\'\'");
        ...
        private CodeStruct Text_Count(BlockModel block)
        {
            string text = Lua.Generator.ValueToCode(block, "TEXT", Lua.ORDER_NONE, "\'\'");
        ...
        private CodeStruct Text_Replace(BlockModel block)
        {
            string text = Lua.Generator.ValueToCode(block, "TEXT", Lua.ORDER_NONE, "\'\'");
        ...
        private CodeStruct Text_Reverse(BlockModel block)
        {
