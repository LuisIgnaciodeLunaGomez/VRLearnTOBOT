...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private CodeStruct List_CreateEmpty(BlockModel block)
        {
            return new CodeStruct("{}", Lua.ORDER_ATOMIC);
        }

        [CodeGenerator(BlockType = "lists_create_with")]
        private CodeStruct List_CreateWith(BlockModel block)
        {
        ...
        private CodeStruct List_Repeat(BlockModel block)
        {
        ...
        private CodeStruct List_Reverse(BlockModel block)
        {
        ...
        private CodeStruct List_IsEmpty(BlockModel block)
        {
        ...
        private CodeStruct List_Length(BlockModel block)
        {
            string list = Lua.Generator.ValueToCode(block, "VALUE", Lua.ORDER_UNARY, "{}");
        ...
        private CodeStruct List_IndexOf(BlockModel block)
        {
            string list = Lua.Generator.ValueToCode(block, "VALUE", Lua.ORDER_UNARY, "{}");
        ...
        private CodeStruct List_GetIndex(BlockModel block)
        {
        ...
        private string List_RemoveIndex(BlockModel block)
        {
            string where = block.GetFieldValue("WHERE");
            if (string.IsNullOrEmpty(where)) where = "FROM_START";
        ...
        private CodeStruct List_SetIndex(BlockModel block)
        {
            string mode = block.GetFieldValue("MODE");
        ...
        private CodeStruct List_GetSubList(BlockModel block)
        {
    ...
    return t", GetListIndexStr("source", where1, "at1"), GetListIndexStr("source", where2, "at2")) +
        ...
        private CodeStruct List_Sort(BlockModel block)
        {
            string list = Lua.Generator.ValueToCode(block, "LIST", Lua.ORDER_NONE, "{}");
        ...
        private CodeStruct List_Split(BlockModel block)
        {
