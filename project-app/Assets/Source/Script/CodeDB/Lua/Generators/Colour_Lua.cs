...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private CodeStruct Colour_Picker(BlockModel block)
        {
        ...
        private CodeStruct Colour_Random(BlockModel block)
        {
        ...
        private CodeStruct Colour_RGB(BlockModel block)
        {
        ...
        private CodeStruct Colour_Blend(BlockModel block)
        {
