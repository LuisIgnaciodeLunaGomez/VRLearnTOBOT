...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private string Controls_If(BlockModel block)
        {
            int n = 0;
            string code = "";
        ...
        private string Controls_IfElse(BlockModel block)
        {
            return Controls_If(block);
        }

        [CodeGenerator(BlockType = "logic_compare")]
        private CodeStruct Logic_Compare(BlockModel block)
        {
        ...
        private CodeStruct Logic_Operation(BlockModel block)
        {
            // Operations 'and', 'or'.
        ...
        private CodeStruct Logic_Negate(BlockModel block)
        {
        ...
        private CodeStruct Logic_Boolean(BlockModel block)
        {
        ...
        private CodeStruct Logic_Null(BlockModel block)
        {
            return new CodeStruct("nil", Lua.ORDER_ATOMIC);
        }

        [CodeGenerator(BlockType = "logic_ternary")]
        private CodeStruct Logic_Ternary(BlockModel block)
        {
