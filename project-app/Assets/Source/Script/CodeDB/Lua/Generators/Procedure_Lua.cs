...
namespace UBlockly
{
    public partial class LuaGenerator
    {
        ...
        private object Procedure_DefReturn(BlockModel block)
        {
        ...
        private object Procedure_DefNoReturn(BlockModel block)
        {
            return Procedure_DefReturn(block);
        }

        [CodeGenerator(BlockType = "procedures_callreturn")]
        private CodeStruct Procedure_CallReturn(BlockModel block)
        {
        ...
        private string Procedure_CallNoReturn(BlockModel block)
        {
            return Procedure_CallReturn(block).code + "\n";
        }

        [CodeGenerator(BlockType = "procedures_ifreturn")]
        private string Proceudre_IfReturn(BlockModel block)
        {
