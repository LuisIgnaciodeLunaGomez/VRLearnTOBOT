...
namespace UBlockly
{
    ...
    public class Connection : Observable<Connection.UpdateState>
    {
        ...
        public Connection(BlockModel source, Define.EConnection type)
        {
            Type = type;
            SourceBlock = source;
        }
        ...
        public static Connection SingleConnection(BlockModel block, BlockModel orphanBlock)
        {
        ...
        public static Connection LastConnectionInRow(BlockModel startBlock, BlockModel orphanBlock)
        {
