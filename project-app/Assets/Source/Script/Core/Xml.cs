...
//                if  TODO: editable is true (!string.IsNullOrEmpty(field.Name) && field.Editable)
        ...
        public static BlockModel DomToBlock(XmlNode xmlBlock, Workspace workspace)
        {
        ...
        /// <param name="xmlBlock"> XML block element.</param>
        /// <param name="workspace"> The workspace</param>
        public static BlockModel DomToBlockHeadless(XmlNode xmlBlock, Workspace workspace)
        {
...
//                            block.nextConnection.setShadowDom(childShadowNode);
        ...
        internal static void DomToWorkspace(object dom, Workspace workspace)
        {
