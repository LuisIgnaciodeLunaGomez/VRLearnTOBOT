    ...
    ***************************/
    ...
    public class BlockModel : Observable<int>
    {
        ...
        public Vector2 XY
        {
            ...
            set
            {
                // LOG DE ASIGNACIÓN EN MODELO
               // Logger.Log($"<color=green><b>[BlockModel.XY.set]</b>:</color> Modelo {ID} recibiendo nueva posición: {value}");
                mXY = value;
        ...
        public BlockModel(Workspace workspace, string prototypeName = null, string opt_id = null)
        {
            Type = prototypeName;
        ...
        /// </summary>
        public ConnectionModel GetFirstClassConnection(Define.EConnection connectionType)
        {
