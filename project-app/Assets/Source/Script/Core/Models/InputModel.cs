...
namespace UBlockly
{
    public class InputModel
    {
        ...
        public InputModel(Define.EConnection type, string name, BlockModel block, ConnectionModel connection = null)
        {
        ...
        /// Class for an input with an optional field.
        /// </summary>
        public InputModel(Define.EConnection type, string name, ConnectionModel connection = null) : this(type, name, null, connection)
        {
        }
        ...
        /// </summary>
        public InputModel SetAlign(Define.EAlign align)
        {
            if (this.Align != align)
            {
                this.Align = align;
