...
namespace UBlockly
{
    ...
    /// </summary>
    public class ConnectionModel : Observable<ConnectionModel.UpdateState>
    {
        ...
        public ConnectionModel(BlockModel source, Define.EConnection type)
        {
            Type = type;
            SourceBlock = source;
        }
        ...
        public ConnectionModel(Define.EConnection type) : this(null, type)
        {
        }
        ...
        /// </summary>
        public bool IsConnectionAllowed(ConnectionModel candidate, int maxRadius = 0)
        {
        ...
        /// </summary>
        public int DistanceFrom(ConnectionModel otherConnection)
        {
