...
using UnityEngine;
    ...
    public class Xml
    {
        ...
        public static XmlNode WorkspaceToDom(WorkSpaceModel workspace, bool optNoId = false)
        {
        ...
        public static XmlNode TextToDom(string text)
        {
            ...
            {
                throw new Exception("ScratchBlocks.Xml.textToDom did not obtain a valid XML tree");
            }
        ...
        public static List<string> DomToWorkspace(XmlNode xml, WorkSpaceModel workspace)
        {
        ...
        public static List<string> AppendDomToWorkspace(XmlNode xml, WorkSpaceModel workspace)
        {
        ...
        public static XmlNode BlockToDomWithXY(BlockModel block, bool optNoId)
        {
           // int width = 0; 
        ...
        public static XmlNode BlockToDom(BlockModel block, bool optNoId = false)
        {
            ...
            foreach (var input in block.InputList)
            {
                ...
                var empty = true;
                if (input.Type == EConnection.DummyInput)
                {
                    continue;
                }
                else
                {
                    ...
                    if (input.Type == EConnection.InputValue)
                    {
        ...
        public static void DomToVariables(XmlNode xmlVariables, WorkSpaceModel workspace)
        {
        ...
        public static BlockModel DomToBlock(XmlNode xmlBlock, WorkSpaceModel workspace)
        {
        ...
        public static BlockModel DomToBlockHeadless(XmlNode xmlBlock, WorkSpaceModel workspace)
        {
            ...
            BlockModel block = workspace.NewBlock(prototypeName, id);
            BlockModel blockChild = null;
