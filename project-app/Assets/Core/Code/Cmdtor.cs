...
Descripción: Code interpreter base class for executing block code in Unity.
...
using UnityEngine;
    ...
    public abstract class Cmdtor
    {
        ...
        public IEnumerator Run(BlockModel block)
        {
            Reset();
        ...
        protected abstract IEnumerator OnRun(BlockModel block);
    }
    ...
    {
        protected sealed override IEnumerator OnRun(BlockModel block)
        {
        ...
        protected abstract DataStruct Execute(BlockModel block);
    }
    ...
    public abstract class VoidCmdtor : Cmdtor
    {
        ...
        protected abstract void Execute(BlockModel block);
    }
...
public abstract class EnumeratorCmdtor : Cmdtor
{
    ...
    protected abstract IEnumerator Execute(BlockModel block);
}
