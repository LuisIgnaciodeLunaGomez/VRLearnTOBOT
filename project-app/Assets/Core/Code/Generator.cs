...
Utility functions for generating executable code from ScratchBlocks code.
...
using System.Text.RegularExpressions;
    ...
    public abstract class Generator
    {
        ...
        /// </summary>
        public string WorkspaceToCode(WorkSpaceModel workspace)
        {
            Init(workspace);
        ...
        /// </summary>
        public CodeStruct BlockToCode(BlockModel block)
        {
        ...
        public string ValueToCode(BlockModel block, string name, int outerOrder)
        {
            if (outerOrder < 0)
        ...
        /// </summary>
        public string ValueToCode(BlockModel block, string name, int outerOrder, string defaultCode)
        {
        ...
        /// </summary>
        public string StatementToCode(BlockModel block, string name)
        {
            var targetBlock = block.GetInputTargetBlock(name);
            if (targetBlock == null)
                return "";
        ...
        /// </summary>
        public string StatementToCode(BlockModel block, string name, string defaultCode)
        {
        ...
        /// </summary>
        protected virtual void Init(WorkSpaceModel workspace)
        {
        }
        ...
        /// </summary>
        protected virtual string Scrub(BlockModel block, string code)
        {
            string nextCode = "";
