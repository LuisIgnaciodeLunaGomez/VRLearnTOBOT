...
namespace UBlockly
{
    ...
    public class IndexAtMutator : Mutator
    {
        ...
        {
            internal FieldDropdownModel whereDropdown;
        ...
        protected override void OnAttached()
        {
            if (mBlock.GetField("WHERE") != null)
            {
                ...
                data.whereDropdown = mBlock.GetField("WHERE") as FieldDropdownModel;
            ...
            else if (mBlock.GetField("WHERE1") != null)
            {
                ...
                while (true)
                {
                    FieldDropdownModel dropdown = mBlock.GetField("WHERE" + i) as FieldDropdownModel;
                    if (dropdown == null)
                        break;
                    AtData data = new AtData();
