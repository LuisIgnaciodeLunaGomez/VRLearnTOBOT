...
using System.Collections;
    ...
    public abstract class LoopCmdtor : EnumeratorCmdtor
    {
        ...
        /// </summary>
        public static LoopCmdtor FindParentLoopCmdtor(BlockModel block)
        {
            BlockModel loopBlock = block.GetSurroundParent();
        ...
        /// </summary>
        public static bool SkipRunByControlFlow(BlockModel block)
        {
        ...
        public static bool IsLoopBlock(BlockModel block)
        {
    ...
    public class LoopForEachCmdtor : LoopCmdtor
    {
        protected override IEnumerator Execute(BlockModel block)
        {
            ...
            string variable0 = CSharp.VariableNames.GetName(block.GetFieldValue("VAR"),  "VARIABLES");
    ...
    {
        protected override void Execute(BlockModel block)
        {
