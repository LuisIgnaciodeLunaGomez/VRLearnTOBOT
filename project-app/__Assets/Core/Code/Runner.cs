...
****************************************************************************/
    ...
    public abstract class Runner : Observable<RunnerUpdateState>
    {
        ...
        /// </summary>
        public virtual void Run(WorkSpaceModel workspace) {}
...
public class RunnerUpdateState
{
    ...
    public readonly BlockModel RunningBlock;
    ...
    public RunnerUpdateState(int type, BlockModel runBlock) : this(type)
    {
